...
from bot.helper.telegram_helper.message_utils import sendMessageSleep
...
def sleep(update, context):
    if BASE_URL is None:
        sendMessageSleep('BASE_URL_OF_BOT not provided!', context.bot, update.message)
        ...
        sendMessageSleep(msg, context.bot, update.message)
    else:
        sendMessageSleep('Ping have been stopped, your bot will sleep in less than 30 min.', context.bot, update.message)
