...
def sendMessageSleep(text: str, bot, update: Update):
    try:
        return bot.send_message(update.chat_id,
...
def sendMarkupSleep(text: str, bot, update: Update, reply_markup: InlineKeyboardMarkup):
    return bot.send_message(update.chat_id,
                            reply_to_message_id=update.message_id,
                            text=text, reply_markup=reply_markup, allow_sending_without_reply=True, parse_mode='HTML')
